...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button, fondo):
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        # Destroy bullets, creates fleet and level up.
        bullets.empty()
...
def check_fleet_edges(ai_settings, aliens):
    """Responds appropietly if any aliens have reached an edge."""
    for alien in aliens.sprites():
